...
```{r}
clinical <- read.csv("Clinical_data/clinical_data_processed.csv")
#str(clinical)

clinical_train <- read.csv("Clinical_data/clinical_data_processed_train.csv")
#str(clinical_train)

clinical_test <- read.csv("Clinical_data/clinical_data_processed_test.csv")
#str(clinical_test)
```
