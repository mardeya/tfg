...
```{r}
gam2 <- gam::gam(OS ~ gam::s(age) + gam::s(AFP)+ Diabetes +Alcohol + Sex + Smoking + T_involvment + Evidence_of_cirh + hepatitis_HCV + hepatitis_HBV + Portal_Vein_Thrombosis + Vascular_Invasion + tumor_nodul + Personal_history_cancer + fhx_can, data = clinical_train)
#summary(gam2)
